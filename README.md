...
playable map cannot be embedded in this page. The screenshot below links to a
hosted, fully interactive example:

[![OpenSeaMap example](./example_osm.png)](https://kirienko.github.io/static/GinSul-2024.html)

Open the [interactive example](https://kirienko.github.io/static/GinSul-2024.html) directly.
